...
@njit(parallel=True, fastmath=True)
def compute_fast_NFW(NFW_draw, x_h, y_h, z_h, vx_h, vy_h, vz_h, c, M, Rvir, rd_pos, rd_vel, exp_frac=0, exp_scale=1, nfw_rescale=1,
                    vrms_h=None, f_sigv=None, v_infall=None, vel_sat='NFW', Nthread=64, seed=None):
